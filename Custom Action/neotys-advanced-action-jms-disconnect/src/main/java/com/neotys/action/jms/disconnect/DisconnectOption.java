...
import static com.neotys.jms.JmsParameters.DESTINATION;
 ...
 *
 */
enum DisconnectOption implements Option {

	DestinationName(DESTINATION, Required, True, TEXT,
			"",
			"The JNDI name of the (topic or queue) destination.",
			NON_EMPTY);
	...
	private DisconnectOption(final String name, final OptionalRequired optionalRequired,
